...
def res4_model_ss():
    ...
    model_res4 = ssrn_SS_IN.ResnetBuilder.gaborcnn((1, PATCH_LENGTH*2+1, PATCH_LENGTH*2+1, img_channels), CATEGORY)
...
modelStatsRecord.outputStats(KAPPA_RES_SS4, OA_RES_SS4, AA_RES_SS4, ELEMENT_ACC_RES_SS4,
                             ...
                             'records/' + str(save_name) + '_pca_cnn.txt',
